<template>
  <div class="container-fluid">
    <div class="container">
      <form>
        <div class="row mb-3">
          <label for="inputEmail3" class="col-sm-3 col-form-label">Поиск по ID сущности</label>
          <div class="col-sm-9">
        ...
        <div class="row mb-3">
          <label for="inputEmail3" class="col-sm-3 col-form-label">Поиск по дате создания </label>
          <div class="col-sm-6">
      ...
      <div class="row">
        <table class="table">
          ...
          <tr>
            <th scope="row">{{ history.entity_ID }}</th>
      ...
      <div class="row">
        ...
        <!--	<button @click="Previous()" :disabled="Page == 1" class="col-2 m-4 p-2">Назад</button>-->
