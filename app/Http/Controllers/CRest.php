...
class CRest extends Controller
{
    ...
    static $TYPE_TRANSPORT = 'json';// json or xml
     ...
     static $C_REST_CURRENT_ENCODING = 'UTF-8'; //set current encoding site if encoding unequal UTF-8 to use iconv()
    ...
    static $C_REST_WEB_HOOK_URL = 'https://xn--24-9kc.xn--d1ao9c.xn--p1ai/rest/53083/b4ye1avz6dmkned1/';  //url on creat Webhook
// or
    static $C_REST_CLIENT_ID = ''; //Application ID
    static $C_REST_CLIENT_SECRET = '';//Application key
        ...
        if (array_key_exists('total', $review_request_first) and $review_request_first['total'] >= 50) {
            ...
            if ($method == 'tasks.task.list') {
                if (!empty ($review_request_first['result']['tasks'])) {
                    ...
                    return $review_request_first['result']['tasks'];
                }
            } else {
